    ...
    <div className="Frame">
        ...
        <div className="Glass-Login">
          <div className="Head">
            <div className="Group-tool">
              ...
              <button className="loginbutton1" onClick={handdleShowlogin}>
                เข้าใช้งาน
              </button>
          ...
          <div className="Body">
            ...
            <text className="t2">
              หากคุณยังไม่มีบัญชีผู้ใช้ ให้ทำการสมัครสมาชิกก่อน
              หากคุณมีบัญชีอยู่แล้วสามารถเข้าใช้งานระบบได้ที่ปุ่ม "เข้าใช้งาน"
              ด่านล่าง
            </text>
            <div className="zonebutton">
              <button className="loginbutton2" onClick={handdleShowlogin}>
                เข้าใช้งาน
              </button>
              <button className="Registered" onClick={handdleShowRegis}>
                สมัครสมาชิก
              </button>
            </div>
          </div>
      ...
      <div className="florr">
        <div className="item1">
          ...
          <li>
            หลังจากนั้นกดที่ปุ่มเข้าใช้งานเพื่อเข้าสู่ระบบ
            ท่านสามารถเข้าถึงทุกฟังก์ชันการใช้งานได้
          </li>
        </div>
        <div className="item2">
          ...
          <li>
            ให้ท่านกรอก Username ของท่าน
            คำแนะนำควรเป็นยูสเซอร์เนมที่ปลอดภัยและจดจำได้ง่าย
          </li>
        ...
        <div className="item3">
          ...
          <li>
            มีระบบดาว เพื่อใช้ในการส่งกับกระทู้ที่ท่านถูกใจ
            หรือแลกเปลี่ยนไอเทมต่างๆ
          </li>
      ...
      <div className={loginmodal ? "Containermodal" : "Container"}>
        <div className="boxlogin">
          ...
          <Link to='/Mainwebsite'>
          <button className="BTN-accept-loginstyle">เข้าสู่ระบบ</button></Link>
        </div>
      </div>
      <div className={Regismodal ? "Containermodal2" : "Container2"}>
        <div className="Box-regisstyle">
          ...
          <text className="Text">
            {" "}
            หลังจากยืนยันเสร็จสิ้น สามารเข้าใช้งานระบบได้ทันที
          </text>
        </div>
        <div className="Boxregis">
           ...
           <text className="settexttopic">Firstname</text>{" "}
            <input
              type="text"
              className="Firsname-regis inputstyleA"
              maxLength={20}
            ></input>
            <text className="settexttopic SLlastname">Lastname</text>
            <input
              type="text"
              className="Lastname-regis inputstyleA"
              maxLength={20}
            ></input>
